...
class Home extends Component {
  ...
  render() {
    return (
      <div className="home" style={this.state.fullScreen ? { position: 'fixed', width: '100%', height: "100%", top: 0 } : { height: 400 }}>
        <div style={{overflow: "scroll",height: "inherit"}}>
          <img style={{width: "100%"}} src="./static/evaluate.png" />
          <div className="button-area">
            <Button className="start-button" type="primary" onClick={this.startClick.bind(this)}>开始评测</Button>
          </div>
          <div className="tip-content" style={{marginBottom: "2rem"}}>
